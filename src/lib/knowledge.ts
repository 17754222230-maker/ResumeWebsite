...
export const experiences: Experience[] = [
  {
    ...
    period: "2026.04 - 至今",
    description:
      "负责飞猪机票自营预订引擎的核心开发，以及代理人经营工作站（业务中台）的建设。",
    highlights: [
      "【机票自营采购预订系统】全业务域预订占编统一通道 · 收益换货决策引擎（30 档策略链/41 归因码）· TBBPM 双轨编排 · VCC 支付接入",
      "【机票代理人经营工作站】DDD 六边形架构中台 · Spring AI 政策文件解析 · Flowable SOP 编排 · 验价链路可观测性",
    ],
  },
  {
    company: "安徽工业大学科技园有限公司",
